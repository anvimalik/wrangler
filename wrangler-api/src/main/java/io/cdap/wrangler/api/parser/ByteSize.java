 ...
 */
 ...
 /**
  * A {@link Token} implementation that parses and represents byte sizes (e.g., "10KB", "5 MB", etc.).
  */
 public class ByteSize implements Token {
   ...
   private static final Pattern BYTE_PATTERN =
       Pattern.compile("(?i)^([0-9]*\\.?[0-9]+)\\s*(B|KB|MB|GB|TB)?$");
   ...
   public String toString() {
     return String.format("ByteSize{original='%s', bytes=%d}", original, bytes);
   }
 }
